        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AddressId = table.Column<int>(type: "int", nullable: false),
                    BirthdayDate = table.Column<DateTime>(type: "datetime", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JuridicalPersonId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Persons_JuridicalPersons_JuridicalPersonId",
                        column: x => x.JuridicalPersonId,
                        principalTable: "JuridicalPersons",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Persons_PhysicalPersons_PhysicalPersonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Persons_JuridicalPersonId",
                table: "Persons",
